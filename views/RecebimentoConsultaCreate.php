...
use ClinicaOdontologica\Controllers\RecebimentoConsultaCreateController;

$controller = new RecebimentoConsultaCreateController();
  ...
  <body class="bg-dark">
    ...
    <div class="container">
      <div class="card card-register mx-auto mt-5">
        ...
        <?php } ?>
          <form action="RecebimentoConsultaCreate.php" method="post">
